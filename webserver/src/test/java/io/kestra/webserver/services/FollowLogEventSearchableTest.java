...
class FollowLogEventSearchableTest {
    ...
    private static final List<PredicateCase> filtersTestCases = List.of(
        ...
        new PredicateCase(baseEvent, filter(Field.DATE, Op.GREATER_THAN_OR_EQUAL_TO, T_NOW), true),
        new PredicateCase(pastEvent, filter(Field.DATE, Op.GREATER_THAN_OR_EQUAL_TO, T_NOW), false),
        new PredicateCase(futureEvent, filter(Field.DATE, Op.GREATER_THAN, T_NOW), true),
        new PredicateCase(baseEvent, filter(Field.DATE, Op.GREATER_THAN, T_NOW), false),
        new PredicateCase(baseEvent, filter(Field.DATE, Op.LESS_THAN_OR_EQUAL_TO, T_NOW), true),
        new PredicateCase(futureEvent, filter(Field.DATE, Op.LESS_THAN_OR_EQUAL_TO, T_NOW), false),
        new PredicateCase(pastEvent, filter(Field.DATE, Op.LESS_THAN, T_NOW), true),
        new PredicateCase(baseEvent, filter(Field.DATE, Op.LESS_THAN, T_NOW), false),
        new PredicateCase(baseEvent, filter(Field.DATE, Op.EQUALS, T_NOW), true),
        new PredicateCase(pastEvent, filter(Field.DATE, Op.EQUALS, T_NOW), false),
        new PredicateCase(pastEvent, filter(Field.DATE, Op.NOT_EQUALS, T_NOW), true),
        new PredicateCase(baseEvent, filter(Field.DATE, Op.NOT_EQUALS, T_NOW), false),
