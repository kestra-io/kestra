...
public class SearchableFactory {
    ...
    public Searchable<Namespace> namespaceSearchable() {
        return Searchable.<Namespace> builder()
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.QUERY, QueryFilter.Op.NOT_EQUALS,
                (ns, v) -> !Strings.CI.contains(ns.getId(), v.toString())
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.NAMESPACE, Namespace::getId,
    ...
    public Searchable<Plugin> pluginSearchable() {
        return Searchable.<Plugin> builder()
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.ARTIFACT_ID, Plugin::getName,
    ...
    public Searchable<FollowLogEvent> followLogEventSearchable(SystemFlowsConfiguration systemFlowsConfiguration) {
        ...
        return Searchable.<FollowLogEvent> builder()
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.SCOPE, QueryFilter.Op.EQUALS,
                (event, v) -> scopeMatches(event, v, systemNamespace)
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.SCOPE, QueryFilter.Op.NOT_EQUALS,
                (event, v) -> !scopeMatches(event, v, systemNamespace)
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.SCOPE, QueryFilter.Op.IN,
                (event, v) -> v instanceof List<?> list
                    && list.stream().anyMatch(item -> scopeMatches(event, item, systemNamespace))
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.SCOPE, QueryFilter.Op.NOT_IN,
                (event, v) -> !(v instanceof List<?> list)
                    || list.stream().noneMatch(item -> scopeMatches(event, item, systemNamespace))
            )

            .searchableQueryFilterExtractor(
                QueryFilter.Field.NAMESPACE, FollowLogEvent::namespace,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.CONTAINS,
                QueryFilter.Op.STARTS_WITH, QueryFilter.Op.ENDS_WITH, QueryFilter.Op.REGEX,
                QueryFilter.Op.IN, QueryFilter.Op.NOT_IN, QueryFilter.Op.PREFIX
            )
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.FLOW_ID, FollowLogEvent::flowId,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.CONTAINS,
                QueryFilter.Op.STARTS_WITH, QueryFilter.Op.ENDS_WITH, QueryFilter.Op.REGEX,
                QueryFilter.Op.IN, QueryFilter.Op.NOT_IN, QueryFilter.Op.PREFIX
            )
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.TRIGGER_ID, FollowLogEvent::triggerId,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.CONTAINS,
                QueryFilter.Op.STARTS_WITH, QueryFilter.Op.ENDS_WITH, QueryFilter.Op.IN, QueryFilter.Op.NOT_IN
            )

            .searchableQueryFilterExtractor(
                QueryFilter.Field.LEVEL, QueryFilter.Op.GREATER_THAN_OR_EQUAL_TO,
            ...
            .searchableQueryFilterExtractor(
                QueryFilter.Field.TASK_ID, FollowLogEvent::taskId,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.CONTAINS,
                QueryFilter.Op.STARTS_WITH, QueryFilter.Op.ENDS_WITH, QueryFilter.Op.IN, QueryFilter.Op.NOT_IN
            )

            .searchableQueryFilterExtractor(
                QueryFilter.Field.TASK_RUN_ID, FollowLogEvent::taskRunId,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.CONTAINS,
                QueryFilter.Op.STARTS_WITH, QueryFilter.Op.ENDS_WITH, QueryFilter.Op.IN, QueryFilter.Op.NOT_IN
            )

            .searchableQueryFilterExtractor(
                QueryFilter.Field.ATTEMPT_NUMBER, FollowLogEvent::attemptNumber,
                QueryFilter.Op.EQUALS, QueryFilter.Op.NOT_EQUALS, QueryFilter.Op.IN, QueryFilter.Op.NOT_IN
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.KIND, QueryFilter.Op.EQUALS,
                (event, v) -> kindMatches(event, v)
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.KIND, QueryFilter.Op.NOT_EQUALS,
                (event, v) -> !kindMatches(event, v)
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.KIND, QueryFilter.Op.IN,
                (event, v) -> asKindList(v).stream().anyMatch(item -> kindMatches(event, item))
            )
            .searchableQueryFilterExtractor(
                QueryFilter.Field.KIND, QueryFilter.Op.NOT_IN,
