...
export const TableInputRows: Story = {
    async play({canvasElement}) {
        ...
        expect(canvasElement.querySelectorAll("[data-test^='table-row-remove-disks-']").length).toBe(1);
        ...
        await waitFor(function rowAdded() {
            expect(canvasElement.querySelectorAll("[data-test^='table-row-remove-disks-']").length).toBe(2);
        });
    },
    render() {
