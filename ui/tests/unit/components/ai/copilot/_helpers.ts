...
export const ksStubs = {
    ...
    KsTag: {name: "KsTag", props: ["size", "type"], template: "<span class=\"ks-tag\" :data-type=\"type\"><slot /></span>"},
    KsTooltip: {name: "KsTooltip", props: ["persistent"], template: "<span class=\"ks-tooltip\"><span class=\"ks-tooltip-content\"><slot name=\"content\" /></span><slot /></span>"},
