...
public class HostMetrics {
    ...
    public static class Hardware {
        ...
        private final boolean isKnownVmMacAddr;
        private final boolean isKnownDockerMacAddr;
    }
    ...
    public static HostMetrics of() {
        ...
        return HostMetrics.builder()
            .uuid(hostUuid)
            .hardware(HostMetrics.Hardware.builder()
                ...
                .isKnownVmMacAddr(hardware.getNetworkIFs().stream().anyMatch(NetworkIF::isKnownVmMacAddr))
                .isKnownDockerMacAddr(hardware.getNetworkIFs().stream().anyMatch(networkIF -> networkIF.getMacaddr().startsWith("02:42:ac")))
                .build()
            )
            .os(HostMetrics.Os.builder()
