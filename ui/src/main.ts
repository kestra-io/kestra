...
import {EDITOR_TASK_ICON_INJECTION_KEY} from "@kestra-io/design-system"
import TaskIcon from "./components/plugins/TaskIcon.vue"


const app = createApp(App)

// lets KsEditor render real plugin icons in Monaco's autocomplete suggestions
// without the design system depending on the app's plugin-icon API
app.provide(EDITOR_TASK_ICON_INJECTION_KEY, TaskIcon)
