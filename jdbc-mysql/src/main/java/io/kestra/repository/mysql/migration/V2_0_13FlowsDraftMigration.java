...
/**
 * OSS MySQL flows draft migration script.
 *
 * <p>
...
public class V2_0_13FlowsDraftMigration extends AbstractSQLMigrationScript {
    ...
    public String description() {
        return "OSS MySQL flows draft: add generated draft column and index";
    }

    @Override
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.13-flows-draft-mysql.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.13-flows-draft-mysql.sql");
    }
}
