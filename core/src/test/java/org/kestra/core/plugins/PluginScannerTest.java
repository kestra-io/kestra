...
class PluginScannerTest {
    ...
    void scanPlugins() throws URISyntaxException {
        ...
        assertThat(scan.get(0).getManifest().getMainAttributes().getValue("X-Kestra-Group"), is("io.kestra.task.templates"));
    }
    ...
    void scanCore() {
        ...
        assertThat(scan.getManifest().getMainAttributes().getValue("X-Kestra-Group"), is("org.kestra.core.tasks"));
    }
}