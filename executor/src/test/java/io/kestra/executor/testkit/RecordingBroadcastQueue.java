 ...
 */
public class RecordingBroadcastQueue<T extends BroadcastEvent> implements BroadcastQueueInterface<T>, Deliverable {
    ...
    public RecordingBroadcastQueue(String name, EmissionJournal journal) {
        this.name = name;
