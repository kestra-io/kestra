<template>
    <nav class="d-flex align-items-center w-100 gap-3 top-bar">
        ...
        <!-- DESKTOP RIGHT AREA (Search always visible) -->
        ...
        <div class="d-flex d-lg-none side gap-2 flex-shrink-0 align-items-center">
            <HamburgerDropdown>
                <div class="d-flex flex-column gap-3 p-3 no-list-style">
                    <GlobalSearch class="trigger-flow-guided-step" />
...
/*  ⚠️ NO CHANGES WERE MADE HERE  
    All of your existing script logic stays exactly the same.  
*/
...
/* Remove list-style-type inside dropdown */
.no-list-style {
