...
import {FLOW, EXECUTION, NAMESPACE} from "../../../../src/components/dependencies/utils/types";
        ...
        return () => (
            <div style="display:flex; gap:12px; height:680px;">
                ...
                <div style="width:380px; height:100%;">
                    <Table elements={getElements()} selected={selectedNodeID.value} onSelect={selectNode} />
                </div>
            </div>
        );
    }
