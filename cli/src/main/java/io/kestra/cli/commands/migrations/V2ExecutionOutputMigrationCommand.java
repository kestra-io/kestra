...
public class V2ExecutionOutputMigrationCommand extends AbstractCommand {
    ...
    @CommandLine.Option(names = "--include-running-created", description = "Include RUNNING and CREATED executions in the migration. By default they are omitted as the `execution-resubmit` command will move their outputs.")
