...
class DefaultExecutorTest {
    ...
    void shouldReleaseTriggerLockWhenTriggerIsPolling() {
        ...
        // When - Then
        assertThat(ExecutorCore.shouldReleaseTriggerLock(flow, execution)).isTrue();
    }
    ...
    void shouldNotReleaseTriggerLockWhenTriggerIsUnscheduled() {
        ...
        // When - Then
        assertThat(ExecutorCore.shouldReleaseTriggerLock(flow, execution)).isFalse();
    }
    ...
    void shouldReleaseTriggerLockWhenTheFlowCarriesNoTriggers() {
        ...
        // When - Then
        assertThat(ExecutorCore.shouldReleaseTriggerLock(FlowWithException.builder().id("flow").namespace("io.kestra.tests").revision(1).build(), execution)).isTrue();
        assertThat(ExecutorCore.shouldReleaseTriggerLock(null, execution)).isTrue();
    }
