...
public class NamespaceContextTool {
    ...
    @Tool(
        "Retrieves KV Store keys available in the namespace. Use this when the user wants to read from or write to the KV Store, or needs to see what keys already exist. Returns a JSON object with namespace and list of key names with their metadata."
    )
