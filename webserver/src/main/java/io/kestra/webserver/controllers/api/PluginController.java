...
public class PluginController {
     ...
     * @param pluginGroupTitle the owning plugin artifact's manifest title on its own (for example
     *        {@code "NATS"} for every subgroup of the NATS plugin), without the subgroup
     *        qualification {@code pluginTitle} carries; the UI escalates to it when two triggers
     *        still resolve to the same label
