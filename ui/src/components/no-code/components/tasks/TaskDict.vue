<template>
    ...
    <template v-else>
        <ks-row v-for="(item, index) in currentValue" :key="index" :gutter="10" class="w-100" :data-testid="`task-dict-item-${item[0]}-${index}`">
            <ks-col :span="6">
                <InputText
                    :ref="el => { if (el) keyInputRefs[index] = el }"
                    :modelValue="item[0]"
            ...
            <ks-col :span="2" class="col align-self-center delete">
