 ...
 */
export const _0292596F9 = <ThrowOnError extends boolean = true>(parameters: {
    tenant: string;
    body: Array<string>;
}, options?: Options<never, ThrowOnError>) => {
    const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'tenant' }, { key: 'body', map: 'body' }] }]);
    return (options?.client ?? client).delete<DeleteLogsByIdsResponses, DeleteLogsByIdsErrors, ThrowOnError>({
 ...
 */
export const _075A36Ca9 = <ThrowOnError extends boolean = true>(parameters: {
    tenant: string;
    filters?: Array<QueryFilter> | null;
}, options?: Options<never, ThrowOnError>) => {
    const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'tenant' }, { in: 'query', key: 'filters' }] }]);
    return (options?.client ?? client).delete<DeleteLogsByQueryResponses, DeleteLogsByQueryErrors, ThrowOnError>({
