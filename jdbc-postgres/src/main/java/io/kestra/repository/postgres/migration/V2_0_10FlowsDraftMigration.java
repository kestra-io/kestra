...
public class V2_0_10FlowsDraftMigration extends AbstractSQLMigrationScript {
    ...
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.10-flows-draft-postgres.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.10-flows-draft-postgres.sql");
    }
}
