...
/**
 * Abstract base for the 2.0.09 execution outputs migration.
 *
 * <p>
 ...
 */
public abstract class AbstractV2_0_09ExecutionOutputsMigration extends AbstractSQLMigrationScript {

    @Override
    public String scriptId() {
        return "2.0.09-execution-outputs";
    }
