...
abstract public class Task implements TaskInterface {
    ...
    @PluginProperty(hidden = true, group = "advanced")
    @Schema(description = "Identifiers of `enforcement: REFERENCE` governance policies to attach to this task and everything nested under it (Enterprise Edition; ignored in the open-source edition).")
