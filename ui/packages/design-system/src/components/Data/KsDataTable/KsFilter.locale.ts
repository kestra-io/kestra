    ...
    "pl": {
        ...
        "filter": {
            ...
            "comparator_descriptions": {
                ...
                "IS_NULL": "Key Labela nie istnieje",
                "IS_NOT_NULL": "Key Labela istnieje z dowolną wartością",
            ...
            "hierarchy": {
                "all": "Domyślny",
                "child_description": "Pokaż tylko zagnieżdżone lub wyzwolone Executiony",
                "parent_description": "Pokaż tylko Executiony najwyższego poziomu",
            },
            "execution_kind": {
                "normal": "Normalny",
                "playground": "Playground",
                "loop": "Pętla",
                "test": "Test",
                "normal_description": "Zwykłe Executiony",
                "playground_description": "Executiony uruchomione w trybie Playground",
                "loop_description": "Executiony utworzone przez Task Loop",
                "test_description": "Executiony uruchomione przez testy jednostkowe",
            },
            "scope": {
                "label": "Zakres",
                "description": "Filtruj według zakresu Executiona",
            },
            "namespace": {
                "label": "Namespace",
            ...
            "kind": {
                "label": "Rodzaj",
                "description": "Filtruj według rodzaju Executiona",
            },
            "state": {
                "label": "Status",
                "description": "Filtruj według statusu Executiona",
            },
            "state_group": {
                "running": "W toku",
                "paused": "Wstrzymano",
            ...
            "childFilter": {
                "label": "Hierarchia",
                "description": "Filtruj według hierarchii Executionów",
            },
            "timeRange": {
                "label": "Interwał",
                "description": "Filtruj według czasu Executiona",
                "applyTo": "Zastosuj do",
                "chip": {
                    "start": "Rozpoczęto",
                    "end": "Zakończono",
            ...
            "timeRange_trigger": {
                ...
                "chip": {
                    "nextExecution": "Następny Execution",
                    "lastTriggered": "Ostatnie uruchomienie",
                },
                "dateFilter": {
                    "nextExecutionDate": "Data następnego Executiona",
            ...
            "labels_execution": {
                "label": "Etykiety",
                "description": "Filtruj według Labeli Executiona",
            },
            "labels_flow": {
                "label": "Etykiety",
                "description": "Filtruj według Labeli Flow",
            },
            "triggerExecutionId": {
                "label": "ID Executiona Triggera",
                "description": "Filtruj według ID Executiona Triggera",
            },
            "triggerState": {
            ...
            "table_column": {
                ...
                "flows": {
                    "labels": "Labele Flow (format Key:Value)",
                    "namespace": "Namespace Flow",
                    "last execution date": "Kiedy Flow był ostatnio uruchamiany",
                    "last execution status": "Status ostatniego Executiona",
                    "execution statistics": "Wykres z ostatnimi statusami Executionów",
                ...
                "executions": {
                    "id": "ID Executiona",
                    "start-date": "Kiedy Execution się rozpoczął",
                    "end-date": "Kiedy Execution się zakończył",
                    "duration": "Całkowity czas działania Executiona",
                    "namespace": "Namespace, do którego należy uruchomiony Flow",
                    "flow": "ID uruchomionego Flow",
                    "labels": "Labele Executiona (format Key:Value)",
                    "state": "Bieżący status Executiona",
                    "revision": "Rewizja Flow użyta dla tego Executiona",
                    "inputs": "Wartości Inputów przekazane do Executiona",
                    "task-id": "ID ostatniego Taska w Executionie",
                    "trigger": "Trigger, który uruchomił Execution",
            ...
            "titles": {
                "flow_execution_filters": "Filtry Executionów Flow",
                ...
                "execution_filters": "Filtry Executionów",
            ...
            "search_placeholders": {
                ...
                "search_executions": "Szukaj Executionów",
                ...
                "search_secrets": "Szukaj Secretów",
