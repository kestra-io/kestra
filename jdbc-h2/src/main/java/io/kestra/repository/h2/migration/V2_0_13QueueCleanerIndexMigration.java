...
public class V2_0_13QueueCleanerIndexMigration extends AbstractSQLMigrationScript {
    ...
    public String description() {
        return "H2 queue upgrade: reorder the queue cleaner index to (type, created)";
    }

    @Override
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.13-queue-cleaner-index-h2.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.13-queue-cleaner-index-h2.sql");
    }
}
