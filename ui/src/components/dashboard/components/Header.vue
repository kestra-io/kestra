...
<script setup lang="ts">
    ...
    const isAllowedFlow = computed(() => user.value.isAllowedGlobal(permission.FLOW, action.CREATE));
    const isAllowedDashboard = computed(() => user.value.isAllowedGlobal(permission.DASHBOARD, action.CREATE));
