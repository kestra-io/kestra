        ...
        <el-container :class="['container', themeClass]">
            <el-main>
                ...
                <el-row>
                    ...
                    <el-col
                        :span="24"
                        style="margin-top: 30px; font-weight: 900"
                    >
                        <el-title level="2">
                ...
                <el-col :span="8" class="card__wrap--inner">
                    <el-card shadow="hover" class="card">
                        ...
                        <div class="card__footer">
                            <el-title level="3">
                                <el-link
                                    href="https://kestra.io/docs/installation"
                                    target="__blank"
                                    type="primary"
                    ...
                    <el-card shadow="hover" class="card">
                        <div class="card__item">
                            <el-title level="3" style="margin-bottom: 10px">
                                {{
                                    $t(
                                        "no-executions-view.workflow_components_title",
                                    )
                                }}
                            </el-title>
                        </div>
                        <div class="card__sub">
                            <el-title level="3">
                                {{
                                    $t(
                                        "no-executions-view.workflow_components_desc",
                                    )
                                }}
                            </el-title>
                        </div>
                        ...
                        <div class="card__footer">
                            <el-link
                                href="https://kestra.io/docs/getting-started/workflow-components"
                                target="__blank"
                                type="primary"
                                style="padding-top: 35px"
                            >
                    ...
                    <el-card shadow="hover" class="card">
                        <div class="card__item">
                            <el-title level="3" style="margin-bottom: 10px">
                                {{
                                    $t(
                                        "no-executions-view.videos_tutorials_title",
                                    )
                                }}
                            </el-title>
                        </div>
                        <div class="card__sub">
                            <el-title level="3" style="margin-bottom: 10px">
                                {{
                                    $t(
                                        "no-executions-view.videos_tutorials_desc",
                                    )
                                }}
                            </el-title>
                        </div>
                        <div class="card__footer">
                            <el-link
                                href="https://kestra.io/docs/tutorial"
                                target="__blank"
                                type="primary"
