...
/**
 * MySQL migration: add a nullable {@code locks.tenant_id} generated column so
...
public class V2_0_20LocksTenantIdMigration extends AbstractSQLMigrationScript {
    ...
    public String description() {
        return "MySQL: add nullable locks.tenant_id generated column for tenant-scoped lease queries";
    }

    @Override
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.20-locks-tenant-id-mysql.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.20-locks-tenant-id-mysql.sql");
    }
}
