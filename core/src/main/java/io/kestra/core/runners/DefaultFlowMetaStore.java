...
public class DefaultFlowMetaStore implements FlowMetaStoreInterface {
    ...
    public DefaultFlowMetaStore(FlowRepositoryInterface flowRepository, FlowParsingService flowParsingService, BroadcastQueueInterface<FlowInterface> flowQueue, FlowWithDefaultCache withDefaultCache) {
