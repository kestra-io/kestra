...
/**
 * In-memory {@link BroadcastQueueInterface} that records every emitted message for assertions.
 * Consumption is not supported: the testkit never starts queue subscriptions.
 */
public class RecordingBroadcastQueue<T extends BroadcastEvent> implements BroadcastQueueInterface<T> {
    ...
    public QueueSubscriber<T> subscriber() {
        throw new UnsupportedOperationException("RecordingBroadcastQueue does not support subscriptions");
    }

    @Override
    public void addListener(Consumer<T> listener) {
        throw new UnsupportedOperationException("RecordingBroadcastQueue does not support listeners");
    }
