...
export async function render(markdown: string, options: {onlyLink?: boolean, permalink?: boolean} = {}) {
    ...
    md.use(mark)
        ...
        .use(container, "info")
        .use(fromHighlighter(highlighter as any, {theme: darkTheme ? "github-dark" : "github-light"}))
        .use(linkTag);
