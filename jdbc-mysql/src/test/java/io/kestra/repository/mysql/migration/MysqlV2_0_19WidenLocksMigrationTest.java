...
/**
 * MySQL-specific integration test for the {@code locks} table's key/id width, created directly at
 * their final size by {@link V2_0_01SchemaMigration}'s CREATE TABLE. Proves an existing row
 * survives a rerun of the migration, that the column accepts an asset-sized id, and that
