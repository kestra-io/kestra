...
/**
 * Postgres task output index migration script.
 *
 * <p>
...
public class V2_0_10TaskOutputIndexMigration extends AbstractSQLMigrationScript {
    ...
    public String description() {
        return "Postgres task output index migration script: add an index for taskrunId inside the `task_outputs` table.";
    }
