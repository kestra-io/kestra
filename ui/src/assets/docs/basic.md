...
| `afterExecution`             | The list of [afterExecution](https://kestra.io/docs/workflow-components/afterexecution) that will run after the workflow is complete. These tasks will run after execution of the workflow is complete, including the execution of the finally tasks.                                                                                                                                                                                               |
...
| `{{ ["apple", "pear", "banana"] contains "apple" }}`                                               | Checks if a collection contains a particular item.                                                                              |
