...
public abstract class AbstractScheduler implements Scheduler {
            ...
            .flatMap(flow -> flow.getTriggers()
                ...
                .map(abstractTrigger -> {
                    ...
                    if (lastTrigger == null) {
                        ...
                        this.triggerState.save(triggerContext, scheduleContext, "computeSchedulable-274");
                    } else {
                    ...
                    try {
                        ...
                        if (shouldEvaluate) {
                            ...
                            if (f.getPollingTrigger().getInterval() != null) {
                                ...
                                try {
                                    this.triggerState.save(triggerRunning, scheduleContext, "handle-376");
                                ...
                                if (schedulerExecutionWithTrigger.isPresent()) {
                                    ...
                                    this.triggerState.save(trigger, scheduleContext, "handle-402");
                                }
                            } else {
                                logService.logTrigger(
                                    f.getTriggerContext(),
                            ...
                            this.triggerState.save(trigger, scheduleContext, "handle-420");
                        }
                        ...
                        this.saveLastTriggerAndEmitExecution(execution, trigger, triggerToSave -> this.triggerState.save(triggerToSave, scheduleContext, "handle-437"));
                    }
                });
        });
    }
    ...
    private void handleEvaluateSchedulingTriggerResult(Schedule schedule, SchedulerExecutionWithTrigger result, ConditionContext conditionContext, ScheduleContextInterface scheduleContext) {
        ...
        this.saveLastTriggerAndEmitExecution(result.getExecution(), trigger, triggerToSave -> this.triggerState.save(triggerToSave, scheduleContext, "handleEvaluateSchedulingTriggerResult-477"));
    }
