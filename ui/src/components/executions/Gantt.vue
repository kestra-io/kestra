                    ...
                    >
                        <div class="d-flex flex-column">
                            <div class="gantt-row d-flex cursor-icon" @click="onTaskSelect(item.id)">
                                ...
                                <el-tooltip placement="top-start" :persistent="false" transition="el-fade-in-linear" :hideAfter="verticalLayout ? 100 : 0" effect="light">
                                    <template #content>
                                        <code>{{ item.name }}</code>
                                ...
                                <div>
                                    <el-tooltip v-if="item.attempts > 1" placement="right" :persistent="false" transition="el-fade-in-linear" :hideAfter="verticalLayout ? 100 : 0" effect="light">
                                        <template #content>
                                ...
                                <div :style="'width: ' + (100 / (dates.length + 1)) * dates.length + '%'">
                                    <el-tooltip placement="top" :persistent="false" transition="el-fade-in-linear" :hideAfter="verticalLayout ? 100 : 0" effect="light">
                                        <template #content>
