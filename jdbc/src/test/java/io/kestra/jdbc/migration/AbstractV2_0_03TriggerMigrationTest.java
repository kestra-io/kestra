...
/**
 * Abstract integration tests for {@link V2_0_03TriggerMigration}.
 * Subclassed per JDBC backend (H2, Postgres, MySQL).
 */
@MicronautTest(transactional = false)
@Execution(ExecutionMode.SAME_THREAD)
public abstract class AbstractV2_0_03TriggerMigrationTest {
    ...
    @Inject
    V2_0_03TriggerMigration migration;
    ...
    void shouldReturnCorrectMetadata() {
        assertThat(migration.scriptId()).isEqualTo("2.0.03-triggers");
