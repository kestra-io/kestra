...
/** Resizable – drag the left edge to resize; past 95% it snaps to full screen */
        ...
        template: `
            <div style="padding:24px">
                ...
                <ks-drawer v-model="visible" resizable destroy-on-close>
                    ...
                    <p style="padding:16px">Drag the handle on the left edge to resize. Drag past 95% to snap to full screen.</p>
                </ks-drawer>
            </div>
        `,
    }),
