<template>
    <div class="wrapper">
        <el-checkbox-button v-if="['duration', 'date-time'].includes(schema.format)" v-model="pebble" :label="$t('no_code.togglePebble')" :title="$t('no_code.togglePebble')" class="ks-pebble">
            <IconCodeBracesBox />
        </el-checkbox-button>
        <el-time-picker
