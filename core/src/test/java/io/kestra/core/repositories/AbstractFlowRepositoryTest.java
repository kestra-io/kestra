...
public abstract class AbstractFlowRepositoryTest {
    ...
    void delete() {
        ...
        try {
            assertThat(flowRepository.findById(MAIN_TENANT, save.getNamespace(), save.getId()).isPresent()).isEqualTo(true);
        } catch (Throwable e) {
            deleteFlow(save);
            throw e;
        }
        ...
        assertThat(flowRepository.findById(MAIN_TENANT, flow.getNamespace(), flow.getId()).isPresent()).isEqualTo(false);
        assertThat(flowRepository.findById(MAIN_TENANT, flow.getNamespace(), flow.getId(), Optional.of(save.getRevision())).isPresent()).isEqualTo(true);
    ...
    void updateConflict() {
        ...
        try {
            assertThat(flowRepository.findById(MAIN_TENANT, flow.getNamespace(), flow.getId()).isPresent()).isEqualTo(true);
