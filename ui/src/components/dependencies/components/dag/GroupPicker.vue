...
<script setup lang="ts">
    ...
    /**
     * Closing while a row was hovered would otherwise leave the graph faded against a
     * group that was never pinned. After a selection there is nothing to restore: toggling
     * already applied the right isolation, and re-emitting here would race the prop update
     * and undo it.
     */
    const onHide = (): void => {
        query.value = ""
