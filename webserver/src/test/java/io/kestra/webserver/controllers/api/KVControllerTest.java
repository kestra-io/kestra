...
class KVControllerTest {
    ...
    void deleteKeyValue() throws IOException {
        ...
        assertThat(storageInterface.exists(TENANT_ID, NAMESPACE, toKVUri(NAMESPACE, "my-key"))).isEqualTo(true);
        client.toBlocking().exchange(HttpRequest.DELETE("/api/v1/main/namespaces/" + NAMESPACE + "/kv/my-key"));

        assertThat(storageInterface.exists(TENANT_ID, NAMESPACE, toKVUri(NAMESPACE, "my-key"))).isEqualTo(false);
    }
