...
public class FlowService {
     ...
     * <p>
     * This makes {@code FlowService} the only writer of trigger state outside the scheduler; see
     * {@link TriggerStateStore} for the contract that split obeys. The write targets the primary store, so a
     * scheduler's own cache does not see it — which is why this is confined to states no scheduler evaluates.
     */
