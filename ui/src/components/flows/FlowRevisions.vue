    ...
    <div class="flow-revision" v-if="revisions && revisions.length > 1">
        ...
        <el-row :gutter="15">
            ...
            <el-col :span="12" v-if="revisionRight !== undefined">
                ...
                <crud v-if="revisionRight" class="mt-3" permission="FLOW" :detail="{namespace: $route.params.namespace, flowId: $route.params.id, revision: revisionNumber(revisionRight)}" />
            </el-col>
        </el-row>
