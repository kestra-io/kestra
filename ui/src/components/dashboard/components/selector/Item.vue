<template>
    <el-dropdown-item class="w-100 p-2">
        ...
        <div class="col-auto">
            <el-button v-if="props.dashboard.id !== 'default'" link :icon="isTheDefaultDashboard ? Home : HomeOutline" class="mx-0" @click.stop="props.setAsDefault(props.dashboard.id)" title="set as default" />
...
<script setup lang="ts">
    ...
    const isTheDefaultDashboard = computed(() => dashboardStore.isDefaultDashboard(props.dashboard.id, route))
</script>
