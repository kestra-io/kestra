    ...
    >
        ...
        <div class="p-3 pt-0">
            ...
            <ks-radio-group v-model="replayRevisionMode" class="radio-vertical">
                <ks-radio label="original" class="radio-item">
                    {{ t("flow revision original") }}
                </ks-radio>
                <ks-radio label="latest" class="radio-item">
                    {{ t("flow revision latest") }}
                </ks-radio>
                <ks-radio label="specific" class="radio-item">
            ...
            <ks-radio-group v-model="inputMode" class="radio-vertical">
                <ks-radio label="reuse" class="radio-item">
                    {{ t("reuse original inputs") }}
                </ks-radio>
                <ks-radio label="modify" class="radio-item">
                    {{ t("modify inputs") }}
                </ks-radio>
            </ks-radio-group>
        </div>
