 ...
 *
 * Only removes the running counter of the limit: the limit itself, if still defined on the flow, the namespace or the tenant, is re-initialized on the next execution.
 */
export const _06C229C4d = <ThrowOnError extends boolean = true>(parameters: {
    tenant: string;
    namespace: string;
    flowId: string;
}, options?: Options<never, ThrowOnError>): RequestResult<DeleteConcurrencyLimitResponses, unknown, ThrowOnError> => {
    const params = buildClientParams([parameters], [{ args: [
                { in: 'path', key: 'tenant' },
                { in: 'query', key: 'namespace' },
                { in: 'query', key: 'flowId' }
            ] }]);
    return (options?.client ?? client).delete<DeleteConcurrencyLimitResponses, unknown, ThrowOnError>({
 ...
 *
 * The concurrency limit is identified by the namespace and flowId of the body: both are set for a flow scoped limit, flowId is empty for a namespace scoped limit, and both are empty for a tenant scoped limit.
 */
export const _06666E52f = <ThrowOnError extends boolean = true>(parameters: {
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'tenant' }, { key: 'concurrencyLimit', map: 'body' }] }]);
...
export const _1E39Ce0f = <ThrowOnError extends boolean = true>(parameters: {
    ...
    flowId: string;
    tenant: string;
}, options?: Options<never, ThrowOnError>): RequestResult<GetExecutionAverageDurationResponses, unknown, ThrowOnError> => {
    const params = buildClientParams([parameters], [{ args: [
                { in: 'path', key: 'namespace' },
                { in: 'path', key: 'flowId' },
                { in: 'path', key: 'tenant' }
...
}, options?: Options<never, ThrowOnError>): RequestResult<ApplyReplaceBySourceCodeResponses, unknown, ThrowOnError> => {
...
}, options?: Options<never, ThrowOnError>): RequestResult<ReplaceLineBySourceCodeResponses, unknown, ThrowOnError> => {
...
}, options?: Options<never, ThrowOnError>): RequestResult<PreviewReplaceBySourceCodeResponses, unknown, ThrowOnError> => {
