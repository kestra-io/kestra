...
/**
 * OSS H2 Flyway upgrade migration script.
 *
...
public class V2_0UpgradeMigration extends AbstractSQLMigrationScript {
    ...
    private static final String CHECKSUM = "h2-upgrade-v2.0";
    ...
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/upgrade-v2.0-h2.sql");
    }
}
