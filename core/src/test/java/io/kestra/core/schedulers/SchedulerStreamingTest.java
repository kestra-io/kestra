...
public class SchedulerStreamingTest extends AbstractSchedulerTest {
    ...
    void simple() throws Exception {
        ...
        this.run(
            ...
            executionList -> {
                ...
                assertThat(SchedulerStreamingTest.startedEvaluate, is(1));
                assertThat(last.getTrigger().getVariables().get("startedEvaluate"), is(1));
            }
        );

        SchedulerStreamingTest.startedEvaluate = 0;
    }
    ...
    void failed() throws Exception {
        ...
        this.run(
            ...
            executionList -> {
                ...
                assertThat(SchedulerStreamingTest.startedEvaluate, greaterThan(1));
            }
        );
    ...
    protected static int startedEvaluate = 0;
                ...
                for (int i = 0; i < executionsToCreate; i++) {
                    ...
                    try {
                        Execution execution = TriggerService.generateExecution(
                            ...
                            context,
                            ImmutableMap.of(
                            "startedEvaluate", startedEvaluate,
