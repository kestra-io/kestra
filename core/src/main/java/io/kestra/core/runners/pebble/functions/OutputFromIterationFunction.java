    ...
    public Object execute(Map<String, Object> args,
        ...
        if (indexObj == null) {
            throw new PebbleException(null,
                "The 'outputFromIteration' function requires an argument named 'index'.",
        ...
        try {
            ...
            throw new PebbleException(e,
                "The 'index' argument for 'outputFromIteration' must be an integer, but got: " + indexObj,
                lineNumber, self.getName());
        }

        if (index < 0) {
            throw new PebbleException(null,
                "Cannot fetch iteration " + index + ": no previous iteration exists.",
                lineNumber, self.getName());
        }
