import type {KestraHttpClient} from "./kestraHttp"
import {apiUrl} from "override/utils/route"
import type {Execution} from "../stores/executions"

export function waitFor($http: KestraHttpClient, execution: {id: string}, predicate: (data: any) => boolean) {
...
export function waitForState($http: KestraHttpClient, execution: Execution) {
