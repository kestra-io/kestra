...
describe("buildTriggerDisplayNames", () => {
    ...
    test("escalates to the plugin artifact's title when the subgroup title itself collides", () => {
        // io.kestra.plugin.nats.core and io.kestra.plugin.datagen.core both resolve their
        // subgroup title to a bare "core", so pluginTitle alone still renders two identical
        // "core Realtime" cards (review round 2).
        const triggers = [
