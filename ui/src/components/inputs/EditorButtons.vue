...
<style scoped lang="scss">
    ...
    @keyframes onboardingSaveExecutePulse {
        from {
            ...
            box-shadow:
                0 0 0 0 color-mix(in srgb, var(--ks-btn-primary-bg-default) 42%, transparent),
                0 0 14px 4px color-mix(in srgb, var(--ks-btn-primary-bg-default) 28%, transparent);
        }

        to {
            transform: translateZ(0) scale(1.04);
            box-shadow:
                0 0 0 8px color-mix(in srgb, var(--ks-btn-primary-bg-default) 12%, transparent),
                0 0 22px 8px color-mix(in srgb, var(--ks-btn-primary-bg-default) 34%, transparent),
                0 0 36px 14px color-mix(in srgb, var(--ks-btn-primary-bg-default) 20%, transparent);
        }
    }
    ...
    @keyframes onboardingSaveExecutePulseDark {
        from {
            transform: translateZ(0) scale(1);
            box-shadow:
                0 0 0 0 color-mix(in srgb, var(--ks-btn-primary-bg-default) 54%, transparent),
                0 0 16px 5px color-mix(in srgb, var(--ks-btn-primary-bg-default) 34%, transparent);
        }

        to {
            transform: translateZ(0) scale(1.035);
            box-shadow:
                0 0 0 10px color-mix(in srgb, var(--ks-btn-primary-bg-default) 14%, transparent),
                0 0 24px 9px color-mix(in srgb, var(--ks-btn-primary-bg-default) 40%, transparent),
                0 0 42px 16px color-mix(in srgb, var(--ks-btn-primary-bg-default) 24%, transparent);
        }
    }
</style>
