...
public interface WorkerTriggerIntervalInterface {
    @Schema(
    ...
    ZonedDateTime nextEvaluationDate();

    ZonedDateTime nextEvaluationDate(ConditionContext conditionContext, Optional<? extends TriggerContext> last) throws Exception;
}
