...
public class V2_0_04BasicAuthPasswordMigration implements MigrationScript {
    ...
    @Inject
    public V2_0_04BasicAuthPasswordMigration(final JooqDSLContextWrapper dslContextWrapper) {
        this.dslContextWrapper = dslContextWrapper;
    }

    @Override
    public String scriptId() {
        return "2.0.04-basic-auth-password";
    }
