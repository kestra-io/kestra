...
public class CurrentOutputFunctionTest  extends AbstractMemoryRunnerTest {
    ...
    void parallel() throws TimeoutException {
        ...
        var output = (Map<String, Object>) execution.outputs().get("1-1-1_return");
        var outputv11 = (Map<String, Object>) output.get("v11");
        ...
        var outputv12 = (Map<String, Object>) output.get("v12");
