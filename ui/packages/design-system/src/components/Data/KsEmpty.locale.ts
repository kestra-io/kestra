export default {
    ...
    "de": {
        "no_data": "Sieht aus, als wäre hier noch nichts…\nPasse deine Filter an oder versuch es noch einmal!",
    },
    "es": {
    ...
    "hi": {
        "no_data": "ऐसा लगता है कि यहाँ कुछ नहीं है... अभी तक!\nअपने फ़िल्टर समायोजित करें, या इसे फिर से आज़माएँ!",
    },
    "it": {
        "no_data": "Sembra che non ci sia ancora nulla qui… per ora!\nModifica i tuoi filtri o riprova!",
    },
    "ja": {
