...
import static io.kestra.jdbc.migration.V2_0_04BasicAuthPasswordMigration.BASIC_AUTH_SETTINGS_KEY;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Abstract integration tests for {@link V2_0_04BasicAuthPasswordMigration}.
 * Subclassed per JDBC backend (H2, Postgres, MySQL).
 */
@MicronautTest(transactional = false)
@Execution(ExecutionMode.SAME_THREAD)
public abstract class AbstractV2_0_04BasicAuthPasswordMigrationTest {
    ...
    @Inject
    V2_0_04BasicAuthPasswordMigration migration;
