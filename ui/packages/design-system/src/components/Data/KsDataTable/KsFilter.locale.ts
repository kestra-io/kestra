export default {
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Time the execution spent waiting in the queue before it started running",
    ...
    "de": {
        ...
        "filter": {
            ...
            "delete filter confirm": "Möchtest du diesen Filter wirklich entfernen?",
            ...
            "select filter": "Filter zum Hinzufügen auswählen",
            ...
            "unrenderable_body": "Diese Abfrage verwendet eine Verschachtelung, die der visuelle Filter-Editor nicht darstellen kann. Bearbeite sie direkt hier oder wende sie an, um sie zu vereinfachen.",
            ...
            "empty subtitle": "Speichere deinen aktiven Filter, um ihn später wiederzuverwenden",
            ...
            "comparator_descriptions": {
                ...
                "STARTS_WITH": "Text beginnt mit den angegebenen Zeichen",
                ...
                "IS_NULL": "Label-Key existiert nicht",
                "IS_NOT_NULL": "Label-Key existiert mit beliebigem Wert",
                "REGEX": "Erweiterte Mustererkennung mit regulären Ausdrücken",
                "PREFIX": "Abgleich der Namespace-Hierarchie (z. B. passt 'com.example' auf 'com.example.app')",
            },
            "hierarchy": {
                "all": "Standard",
                "child_description": "Nur verschachtelte oder ausgelöste Executions anzeigen",
                "parent_description": "Nur Executions der obersten Ebene anzeigen",
            },
            "execution_kind": {
                "normal": "Normal",
                "playground": "Playground",
            ...
            "scope": {
                "label": "Bereich",
                "description": "Nach Execution-Bereich filtern",
            },
            "namespace": {
                "label": "Namespace",
            ...
            "kind": {
                "label": "Art",
                "description": "Nach Execution-Art filtern",
            },
            "state": {
                "label": "Status",
                "description": "Nach Execution-Status filtern",
            },
            "state_group": {
                "running": "Laufend",
                "paused": "Pausiert",
            ...
            "childFilter": {
                "label": "Hierarchie",
                "description": "Nach Execution-Hierarchie filtern",
            },
            "timeRange": {
                "label": "Intervall",
                "description": "Nach Execution-Zeit filtern",
            ...
            "timeRange_trigger": {
                ...
                "chip": {
                    "nextExecution": "Nächste Execution",
                    "lastTriggered": "Zuletzt ausgelöst",
                },
                "dateFilter": {
                    "nextExecutionDate": "Nächstes Execution-Datum",
            ...
            "labels_execution": {
                "label": "Labels",
                "description": "Nach Execution-Labels filtern",
            },
            "labels_flow": {
                "label": "Labels",
            ...
            "triggerExecutionId": {
                "label": "Trigger-Execution-ID",
                "description": "Nach Trigger-Execution-ID filtern",
            },
            "triggerState": {
            ...
            "taskRunId": {
                "label": "Task-Run-ID",
                "description": "Nach Task-Run-ID filtern",
            },
            "attemptNumber": {
            ...
            "task": {
                "label": "Task",
                "description": "Nach Task-Namen filtern",
            },
            "table_column": {
                "mcpTools": {
                    "title": "Anzeigetitel, der AI-Agenten angezeigt wird",
                    ...
                    "namespace": "Namespace des Flows, der dieses Tool definiert",
                    "triggerId": "Trigger-ID innerhalb des Flows, unterscheidet sich vom Tool-Namen",
                    "description": "Was das Tool tut und wann ein Agent es aufrufen sollte",
                },
                "flows": {
                    "labels": "Flow-Labels (Format Key:Value)",
                    "namespace": "Namespace des Flows",
                    "last execution date": "Wann der Flow zuletzt ausgeführt wurde",
                    "last execution status": "Status der letzten Execution",
                    "execution statistics": "Diagramm mit den letzten Execution-Status",
                    "triggers": "Trigger, die den Flow starten können (z. B. Zeitplan, Event)",
                    "last modified": "Wann die Flow-Definition zuletzt aktualisiert wurde",
                },
                "executions": {
                    "id": "Execution-ID",
                    "start-date": "Wann die Execution gestartet wurde",
                    "end-date": "Wann die Execution abgeschlossen wurde",
                    "duration": "Gesamtlaufzeit der Execution",
                    "queued-duration": "Zeit, die die Ausführung in der Warteschlange gewartet hat, bevor sie gestartet wurde",
                ...
                "metrics": {
                    "task": "Task, der die Metrik erzeugt hat",
                    "name": "Name der Metrik",
                    "value": "Wert der Metrik",
                    "tags": "Tags, die mit der Metrik verknüpft sind",
                },
            },
            "titles": {
                "flow_execution_filters": "Filter für Flow-Executions",
                ...
                "execution_filters": "Execution-Filter",
            ...
            "search_placeholders": {
                ...
                "search_executions": "Executions durchsuchen",
                ...
                "search_namespaces": "Namespaces durchsuchen",
                "search_kv": "KV-Paare durchsuchen",
                "search_secrets": "Secrets durchsuchen",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Tiempo que la ejecución pasó esperando en la cola antes de comenzar a ejecutarse",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Temps passé par l'exécution en file d'attente avant son démarrage",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "निष्पादन शुरू होने से पहले कतार में प्रतीक्षा में बिताया गया समय",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Tempo trascorso dall'esecuzione in coda prima dell'avvio",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "end-date": "実行が終了したとき",
                    "duration": "実行の合計ランタイム",
                    "queued-duration": "実行が開始されるまでキューで待機した時間",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "실행이 시작되기 전에 대기열에서 기다린 시간",
    ...
    "pl": {
        ...
        "filter": {
            ...
            "comparator_descriptions": {
                ...
                "IS_NULL": "Key etykiety nie istnieje",
                "IS_NOT_NULL": "Key etykiety istnieje z dowolną wartością",
            ...
            "hierarchy": {
                "all": "Domyślny",
                "child_description": "Pokaż tylko zagnieżdżone lub wyzwolone egzekucje",
                "parent_description": "Pokaż tylko egzekucje najwyższego poziomu",
            },
            "execution_kind": {
                "normal": "Normalny",
                "playground": "Playground",
                "loop": "Pętla",
                "test": "Test",
                "normal_description": "Zwykłe egzekucje",
                "playground_description": "Egzekucje uruchomione w trybie Playground",
                "loop_description": "Egzekucje utworzone przez Task Loop",
                "test_description": "Egzekucje uruchomione przez testy jednostkowe",
            },
            "scope": {
                "label": "Zakres",
                "description": "Filtruj według zakresu egzekucji",
            },
            "namespace": {
                "label": "Namespace",
            ...
            "kind": {
                "label": "Rodzaj",
                "description": "Filtruj według rodzaju egzekucji",
            },
            "state": {
                "label": "Status",
                "description": "Filtruj według statusu egzekucji",
            },
            "state_group": {
                "running": "W toku",
                "paused": "Wstrzymano",
            ...
            "childFilter": {
                "label": "Hierarchia",
                "description": "Filtruj według hierarchii egzekucji",
            },
            "timeRange": {
                "label": "Interwał",
                "description": "Filtruj według czasu egzekucji",
                "applyTo": "Zastosuj do",
                "chip": {
                    "start": "Rozpoczęto",
                    "end": "Zakończono",
            ...
            "timeRange_trigger": {
                ...
                "dateFilter": {
                    "nextExecutionDate": "Data następnej egzekucji",
            ...
            "labels": {
                "label": "Etykiety",
                "description": "Filtruj według etykiet",
            },
            "labels_execution": {
                "label": "Etykiety",
                "description": "Filtruj według etykiet egzekucji",
            },
            "labels_flow": {
                "label": "Etykiety",
                "description": "Filtruj według etykiet Flow",
            },
            "triggerExecutionId": {
                "label": "ID egzekucji Triggera",
                "description": "Filtruj według ID egzekucji Triggera",
            },
            "triggerState": {
                "label": "Status Triggera",
                "description": "Filtruj według statusu Triggera",
                "enabled": "Włączone",
                "disabled": "Wyłączone",
            },
            "triggerLocked": {
            ...
            "table_column": {
                "mcpTools": {
                    ...
                    "triggerId": "ID Triggera w obrębie Flow, inne niż nazwa narzędzia",
                    "description": "Co robi narzędzie i kiedy agent powinien je wywołać",
                },
                "flows": {
                    "labels": "Etykiety Flow (format Key:Value)",
                    "namespace": "Namespace Flow",
                    "last execution date": "Kiedy Flow był ostatnio uruchamiany",
                    "last execution status": "Status ostatniej egzekucji",
                    "execution statistics": "Wykres z ostatnimi statusami egzekucji",
                    "triggers": "Triggery, które mogą uruchomić Flow (np. harmonogram, zdarzenie)",
                    "last modified": "Kiedy definicja Flow była ostatnio aktualizowana",
                },
                "executions": {
                    "id": "ID egzekucji",
                    "start-date": "Kiedy egzekucja się rozpoczęła",
                    "end-date": "Kiedy egzekucja się zakończyła",
                    "duration": "Całkowity czas działania egzekucji",
                    "queued-duration": "Czas, jaki wykonanie spędziło w kolejce przed uruchomieniem",
                    "namespace": "Namespace, do którego należy uruchomiony Flow",
                    "flow": "ID uruchomionego Flow",
                    "labels": "Etykiety egzekucji (format Key:Value)",
                    "state": "Bieżący status egzekucji",
                    "revision": "Wersja Flow użyta dla tej egzekucji",
                    "inputs": "Wartości Inputów przekazane do egzekucji",
                    "task-id": "ID ostatniego Taska w egzekucji",
                    "trigger": "Trigger, który uruchomił egzekucję",
                    "parent-execution": "ID nadrzędnej egzekucji, która uruchomiła tę egzekucję",
                },
                "kv": {
            ...
            "titles": {
                "flow_execution_filters": "Filtry egzekucji Flow",
                ...
                "execution_filters": "Filtry egzekucji",
                "flow_filters": "Filtry Flowów",
            ...
            "search_placeholders": {
                ...
                "search_executions": "Szukaj egzekucji",
                "search_dashboards": "Szukaj Dashboardów…",
                "search_flows": "Szukaj Flowów",
                "search_logs": "Wyszukaj logi",
                "search_metrics": "Wyszukaj metryki",
                "search_triggers": "Szukaj Triggerów",
                "search_namespaces": "Szukaj namespace'ów",
                "search_kv": "Szukaj par KV",
                "search_secrets": "Szukaj sekretów",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Tempo que a execução passou em fila de espera antes de começar a ser executada",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "end-date": "Quando a execução terminar",
                    "duration": "Tempo total de execução",
                    "queued-duration": "Tempo que a execução ficou na fila antes de começar a ser executada",
                    "namespace": "Namespace ao qual o flow executado pertence",
                    "flow": "ID do flow executado",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "queued-duration": "Время, которое выполнение провело в очереди до запуска",
        ...
        "filter": {
            ...
            "table_column": {
                ...
                "executions": {
                    ...
                    "end-date": "执行完成时",
                    "duration": "执行的总运行时间",
                    "queued-duration": "执行在开始运行前在队列中等待的时间",
