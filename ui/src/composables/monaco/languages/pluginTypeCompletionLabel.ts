 ...
 *
 * The design system's `suggestionLabel` puts the two halves back together to resolve the row's plugin icon, so a
 * change to which half carries what has to be made there too.
 */
