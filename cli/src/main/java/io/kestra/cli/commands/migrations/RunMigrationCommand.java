 ...
 *
 * <p>
 * This command is primarily useful in EE where automatic migration on startup is disabled
 ...
 *
 * <p>
 * In OSS, migrations always run automatically, but this command can still be used to apply
 * migrations manually before starting the server (e.g. in a rolling-upgrade scenario).
 *
 * <p>
 * Usage: {@code kestra migrate run}
 */
@Slf4j
@CommandLine.Command(
    name = "run",
