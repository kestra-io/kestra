...
class ClassPluginDocumentationTest {
    ...
    void trigger() throws URISyntaxException {
        Helpers.runApplicationContext(throwConsumer((applicationContext) ->
        {
            ...
            // the assets declaration of the trigger base counts the custom asset, the free-form branch of assets.outputs, and the relation reference partOf/related point at
